...
if (!function_exists('getSEO'))
{
	function getSEO($len = 2) {
		...
		// get the appropriate information for the current page
...
if (!function_exists('getDynamicSEO'))
{
    function getDynamicSEO($config)
    {
        ...
        elseif (key_exists('styleType', $config))
        {
        ...
        elseif (key_exists('seoType', $config) && $config['seoType'] == 'establishmentByCity')
        {
        ...
        elseif (key_exists('seoType', $config) && $config['seoType'] == 'establishmentsByState')
        {
        ...
        elseif (key_exists('seoType', $config) && $config['seoType'] == 'establishmentsByCity')
        {
        ...
        elseif (key_exists('seoType', $config) && $config['seoType'] == 'establishmentByState')
        {
        ...
        elseif (key_exists('seoType', $config) && $config['seoType'] == 'userProfile')
        {
...
if (!function_exists('swap_out_uri'))
{
	function swap_out_uri($search, $replace, $uri)
    {
